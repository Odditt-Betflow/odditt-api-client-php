...
**betting_market_category_ids** | **int[]** | Filter by one or more betting market category IDs (e.g. Shooting Props, Game Props etc.). Empty array &#x3D; no filter. | [optional]
**betting_market_entity_type** | **string** | Filter by betting market entity type | [optional]
**betting_market_ids** | **int[]** | Filter by betting market IDs | [optional]
...
**betting_market_position_ids** | **int[]** | Filter by one or more betting market position IDs. Empty array &#x3D; no filter. | [optional]
**event_id** | **int** | Deprecated — use &#x60;event_ids&#x60; instead. A bare &#x60;event_id&#x60; is treated as &#x60;event_ids: [event_id]&#x60;. | [optional]
**event_ids** | **int[]** | Filter by one or more event IDs. Empty array &#x3D; no filter. | [optional]
...
**league_ids** | **int[]** | Filter by one or more league IDs. Empty array &#x3D; no filter. | [optional]
...
**operator_ids** | **int[]** | Filter by operator IDs | [optional]
**operator_keys** | **string[]** | Filter by operator external keys (e.g. &#39;draftkings&#39;). Format: {operator_key}. Resolved IDs are merged with operator_ids. | [optional]
**page** | **int** |  | [optional]
**page_size** | **int** |  | [optional]
**player_id** | **int** | Deprecated — use &#x60;player_ids&#x60; instead. A bare &#x60;player_id&#x60; is treated as &#x60;player_ids: [player_id]&#x60;. | [optional]
**player_ids** | **int[]** | Filter by one or more player IDs. Empty array &#x3D; no filter. | [optional]
...
**sport_ids** | **int[]** | Filter by one or more sport IDs. Empty array &#x3D; no filter. | [optional]
...
**team_ids** | **int[]** | Filter by one or more team IDs. Empty array &#x3D; no filter. | [optional]
